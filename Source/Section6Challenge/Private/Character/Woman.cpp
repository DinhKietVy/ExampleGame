...
{
	if (ActionState == EActionState::ESC_Attack || bIsAction) return;
...
void AWoman::Jump()
{
	if (ActionState == EActionState::ESC_Attack) return;
...
void AWoman::ETrigger()
{
	...
	else if (CharacterState == ECharacterState::ESC_EquippedOneHanedWeapon && bIsHaveWeapon && ActionState == EActionState::ECS_Unoccupied)
	{
		DisArm();
	}
	else if (CharacterState == ECharacterState::ECS_Unequipped && bIsHaveWeapon && ActionState == EActionState::ECS_Unoccupied)
	{
		Arm();
	}
}
...
void AWoman::Attack()
{
	...
	if (CharacterState == ECharacterState::ESC_EquippedOneHanedWeapon && ActionState != EActionState::ESC_Attack && IsAttack == false)
	{
		ActionState = EActionState::ESC_Attack;
